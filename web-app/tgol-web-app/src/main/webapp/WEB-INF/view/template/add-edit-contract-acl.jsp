                    ...
                    <div id="account-settings-form">
                        <form:form method="post" modelAttribute="createContractCommand" acceptCharset="UTF-8" enctype="application/x-www-form-urlencoded">
                            ...
                            <div id="sign-up-form-general-error">
                                ...
                                <c:set var="userListError"><form:errors path="readers"/></c:set>
                                <c:if test="${not empty userListError}">
                                    <c:set var="userListErrorClass" value="error"/>
                                </c:if>
                            <div class="clearfix ${userListErrorClass}">
                                <label id="user-list-label" for="readers"><fmt:message key="add-contract.users"/></label>
                                <div class="input" >
                                <c:choose>
                                ...
                                <form:select multiple="true" path="readers" size="${selectSize}" class="xlarge" items="${userList}" itemValue="id" itemLabel="email1"/>
                                <form:errors path="readers" cssClass="alert-message error" />
                                </div>
                                <!-- Owner/Writer -->
                                <label id="user-list-label" for="owner"><fmt:message key="add-contract.owner"/></label>
                                <div class="input" >
                                <c:choose>
                                    <c:when test="${fn:length(userList) < 10}">
                                        <c:set var="selectSize" value="${fn:length(userList)}"/>
                                ...
                                <form:select multiple="false" path="owner" size="${selectSize}" class="xlarge" items="${userList}" itemValue="id" itemLabel="email1"/>
                                <form:errors path="readers" cssClass="alert-message error" />
                                </div>
                            </div>
